...
for s=1:NScans
    ...
    twix_obj{s}.image.NCol_protocol=twix_obj{s}.hdr.Phoenix.sKSpace.lBaseResolution;
    twix_obj{s}.refscan.NCol_protocol=twix_obj{s}.hdr.Phoenix.sKSpace.lBaseResolution;
    %---------------------------------------------------------------------
